...
|-------|-----------------------|
| `needs-design` | Do not open a PR from the issue text alone. It needs a design first (posted on the issue or as a doc) and a round of review; the open questions in the issue are open on purpose. |
